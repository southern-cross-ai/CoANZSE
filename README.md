...
The original dataset contains 2 large `.gz` files from [Harvard Dataverse - Corpus of Australian and New Zealand Spoken English](https://doi.org/10.7910/DVN/GW35AK):

- `coanzse_tokens_distributable_02072023.csv.gz`: contains 303 MB untagged corpus;
- `coanzse_textpos_distributable_07092023.csv.gz`: contains 1.0 GB PoS-tagged corpus with word timings.
